...
Пачка изменений, которая либо вся сохраняется (`COMMIT`), либо вся отменяется (`ROLLBACK`). Так операция атомарна: два `UPDATE` перевода со счёта — либо оба, либо ни одного. Пока не закоммитили — для других её как будто нет (в обычном `READ COMMITTED`).
...
Через ЕИС (zakupki.gov.ru). Бюджет и муниципалитеты покупают по 44-ФЗ, госкомпании — по 223-ФЗ. Заказчик публикует закупку, поставщики торгуются на электронных площадках, с победителем контракт. Смотрит ФАС.

---

### 4.3.2 Что регулирует 44 ФЗ?

Закупки государства и муниципалитетов за бюджет: план, торги, контракт, исполнение.

---

### 4.3.3 Что регулирует 223 ФЗ?

Закупки госкорпораций, госкомпаний и компаний с госучастием. Мягче, чем 44-ФЗ: сами пишут положение о закупках.

---

### 4.3.4 Что такое «B to B»?

Одна контора выставляет счёт другой. Не шаурма с карты (B2C) и не тендер на zakupki.gov.ru (B2G).

---

### 4.3.5 Привести пример бизнеса процесса, нарисовать схему бизнес-процесса.

<div align="right"><small><a href="seed-4.3.5.md">seed - 4.3.5.md</a></small></div>

Найм программиста со стороны компании: вакансия, отбор, тестовое, оффер.
