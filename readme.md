...
В SQL Server это `WITH (NOLOCK)`, `OPTION (RECOMPILE)` и т.п. В Postgres из коробки почти нет, но зато можно крутить планировщик: `SET enable_seqscan = off`, `enable_hashjoin`.
