...
После регистрации статус остался 6. Задание каждую минуту снова берёт те же лоты и клепает документ ещё раз. На тесте не заметили: гоняли по разу или лотов почти не было.

После успешной регистрации менять `Bid.StatusId` (или ставить признак «документ уже есть») в той же транзакции, что и сам документ.
